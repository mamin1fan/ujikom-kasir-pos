...
class BarangController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('role.super-admin.barang', compact('barang', 'kategori', 'suppliers', 'kelompok_kategori'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('super-admin.barang.index')->with('success', 'Data berhasil ditambahkan');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($validator->fails()) {
            return redirect()->route('super-admin.barang.index', ['edit_id' => $id])
        ...
        return redirect()->route('super-admin.barang.index')->with('success', 'Data berhasil diupdate');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('super-admin.barang.index')->with('success', 'Data berhasil dihapus');
    }
